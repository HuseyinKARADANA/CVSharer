...
namespace CVSharer.Controllers
{
    public class SessionController : Controller
    {
            ...
            foreach (var user in userList)
            {
                try
                {
                    ...
                    if (decryptedEmail == dto.Email)
                    {
                        ...
                        MailboxAddress mailboxAddressTo = new MailboxAddress(user.Name, dto.Email.ToLower());
                        ...
                        bodyBuilder.HtmlBody = "<!DOCTYPE html>\r\n\r\n<html lang='en' xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:v='urn:schemas-microsoft-com:vml'>\r\n<head>\r\n<title></title>\r\n" +
                            ...
                            "line-height:150%;text-align:left;mso-line-height-alt:22.5px;'>\r\n<p style='margin: 0; word-break: break-word;'>To reset your account's password and access all features, find your verification code below:</p>\r\n</div>\r\n</td>\r\n</tr>\r\n</table>\r\n<table border='0'" +
                        ...
                        message.Subject = "Forgot your password reset code";
                        ...
                        TempData["VerifyCode"] = serializedModel;

                        string serializedModelUser = JsonConvert.SerializeObject(user);
                        TempData["MyUser"] = serializedModelUser;
                        return RedirectToAction("ResetUpdatePassword", "Session");
        ...
        [HttpGet]
        public IActionResult ResetUpdatePassword()
        {
            return View();
        }
        ...
        {
            var model = JsonConvert.DeserializeObject<VerifyDTO>(TempData["VerifyCode"] as string);
            var user = JsonConvert.DeserializeObject<User>(TempData["MyUser"] as string);
            ...
            if (model.verifyCode == dto.verifyCode)
            {
                ...
                if (dto.NewPassword == dto.PasswordAgain)
                {
                    ...
                    _toast.Success("Password successfuly changed.");
                    return RedirectToAction("Login", "Session");
                }
                else
                {
                    _toast.Error("The passwords do not match.");
                    return RedirectToAction("ResetUpdatePassword", "Session");
                }
            }
            else
            {
                _toast.Error("The entered code is invalid.");
                return RedirectToAction("ResetUpdatePassword", "Session");
